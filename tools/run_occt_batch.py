...
def main() -> None:
    ...
    class _Recording(OcctPartBuilder):
        ...
        def build_flat_plate(self, *args, **kwargs):
            part = super().build_flat_plate(*args, **kwargs)
            labels_by_part[kwargs["part_name"]] = part.face_labels
            return part

        def build_branch_part(self, *args, **kwargs):
            part = super().build_branch_part(*args, **kwargs)
            labels_by_part[kwargs["part_name"]] = part.face_labels
            return part
